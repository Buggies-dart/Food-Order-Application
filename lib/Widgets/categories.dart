...
child: GridView.builder( itemCount: chickens.length, scrollDirection: Axis.vertical, physics: const NeverScrollableScrollPhysics(),
   shrinkWrap: true,
...
final showFoods = chickens[index];
 return Padding(
padding: const EdgeInsets.only( left: 8, right: 8), child: GestureDetector( onTap: (){ Navigator.push(context, MaterialPageRoute(builder: (context){
...
label: Column(
children: [
SizedBox( height: MediaQuery.of(context).size.height/9, child: Center(child: Image.network(showFoods['image'], fit: BoxFit.fill,))),
